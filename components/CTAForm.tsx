...
export function CTAForm() {
  ...
  return <form className="form-card" onSubmit={submit} noValidate>
    ...
    <label className="field" htmlFor="message"><span>What is your biggest marketing challenge right now? <em>Optional</em></span><textarea id="message" name="message" placeholder="Tell me briefly about your business and what you would like help with." rows={4} /></label>
    <button className="button submit" type="submit" disabled={loading}>{loading ? "Sending your request..." : "Get My Free AI Marketing Plan"}<span>→</span></button><p className="form-trust">Sashi will review your information and contact you regarding your free consultation.</p><p className="privacy">Your information will only be used regarding your consultation request.</p>
  </form>;
}
